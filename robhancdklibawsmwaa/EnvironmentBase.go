...
func (j *jsiiProxy_EnvironmentBase) Env() *interfaces.ResourceEnvironment {
...
func (e *jsiiProxy_EnvironmentBase) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
