...
type EnvironmentAttributes struct {
	...
	CeleryExecutorQueue *string `field:"optional" json:"celeryExecutorQueue" yaml:"celeryExecutorQueue"`
	// The relative path to the DAGs folder on your Amazon S3 bucket.
	//
	// For example, dags.
	DagS3Path *string `field:"optional" json:"dagS3Path" yaml:"dagS3Path"`
	// The VPC endpoint for the environment's Amazon RDS database.
	DatabaseVpcEndpointService *string `field:"optional" json:"databaseVpcEndpointService" yaml:"databaseVpcEndpointService"`
	...
	LoggingConfigurationDagProcessingLogsCloudWatchLogGroupArn *string `field:"optional" json:"loggingConfigurationDagProcessingLogsCloudWatchLogGroupArn" yaml:"loggingConfigurationDagProcessingLogsCloudWatchLogGroupArn"`
	// The ARN for the CloudWatch Logs group where the Apache Airflow Scheduler logs are published.
	LoggingConfigurationSchedulerLogsCloudWatchLogGroupArn *string `field:"optional" json:"loggingConfigurationSchedulerLogsCloudWatchLogGroupArn" yaml:"loggingConfigurationSchedulerLogsCloudWatchLogGroupArn"`
	// The ARN for the CloudWatch Logs group where the Apache Airflow task logs are published.
	LoggingConfigurationTaskLogsCloudWatchLogGroupArn *string `field:"optional" json:"loggingConfigurationTaskLogsCloudWatchLogGroupArn" yaml:"loggingConfigurationTaskLogsCloudWatchLogGroupArn"`
	// The ARN for the CloudWatch Logs group where the Apache Airflow Web server logs are published.
	LoggingConfigurationWebserverLogsCloudWatchLogGroupArn *string `field:"optional" json:"loggingConfigurationWebserverLogsCloudWatchLogGroupArn" yaml:"loggingConfigurationWebserverLogsCloudWatchLogGroupArn"`
	// The ARN for the CloudWatch Logs group where the Apache Airflow Worker logs are published.
	LoggingConfigurationWorkerLogsCloudWatchLogGroupArn *string `field:"optional" json:"loggingConfigurationWorkerLogsCloudWatchLogGroupArn" yaml:"loggingConfigurationWorkerLogsCloudWatchLogGroupArn"`
	...
	WebserverUrl *string `field:"optional" json:"webserverUrl" yaml:"webserverUrl"`
	// The VPC endpoint for the environment's web server.
	WebserverVpcEndpointService *string `field:"optional" json:"webserverVpcEndpointService" yaml:"webserverVpcEndpointService"`
