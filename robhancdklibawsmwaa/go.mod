module github.com/robert-hanuschke/robhan-cdk-lib-aws-mwaa/robhancdklibawsmwaa

go 1.25

require (
	github.com/aws/jsii-runtime-go v1.140.0
	github.com/robert-hanuschke/robhan-cdk-lib-utils/robhancdklibutils v0.0.327
